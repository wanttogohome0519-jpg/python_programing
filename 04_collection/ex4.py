...
print(sum(a),sum(a))
print(sum(b),sum(b)) # generator는 한번만 사용 가능
...
index = hours.index(max(hours))
print(days[index] + "요일")  # ✅ 토요일


# 4️⃣ 가장 높은 점수와 가장 낮은 점수 출력하기
scores = (90, 85, 78, 92, 88, 76)

print("max 점수:", max(scores), "점")
print("min 점수:", min(scores), "점")
